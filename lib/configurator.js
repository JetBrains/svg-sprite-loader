...
const browserSpriteModule = `${PACKAGE_NAME}/runtime/browser-sprite`;
const browserSymbolModule = `${PACKAGE_NAME}/runtime/browser-symbol`;
...
module.exports = function configurator({ config, context }) {
  ...
  const autodetected = {
    ...
    symbolModule: target === 'web' ? browserSymbolModule : defaults.symbolModule,
