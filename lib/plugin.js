  ...
  apply(compiler) {
    ...
    compiler.plugin('this-compilation', (compilation) => {
      ...
      compilation.plugin('additional-assets', function emitSpriteChunk(done) {
        const sprites = utils.groupSymbolsBySpritefilename(utils.aggregate(symbols, this));
        const spriteFilenames = Object.keys(sprites);

        return Promise.map(spriteFilenames, (spriteFilename) => {
