module.exports.additionalAssets = require('./additional-assets');
module.exports.createSprite = require('./create-sprite');
...
module.exports.generateSprites = require('./generate-sprites');
module.exports.getAllModules = require('./get-all-modules');
module.exports.getLoaderOptions = require('./get-loader-options');
module.exports.getLoadersRules = require('./get-loaders-rules');
...
module.exports.getReplacements = require('./get-replacements');
